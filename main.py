...
class DesktopWidget(QWidget):
    ...
    def init_ui(self):
        ...
        weather_grid.addWidget(QLabel("Sunrise"), 1, 0)
        self.sunrise_val = QLabel("--")
        weather_grid.addWidget(self.sunrise_val, 1, 1)
        
        weather_grid.addWidget(QLabel("Sunset"), 2, 0)
        self.sunset_val = QLabel("--")
        weather_grid.addWidget(self.sunset_val, 2, 1)
        
        weather_grid.addWidget(QLabel("Rain"), 3, 0)
        self.rain_val = QLabel("--%")
        weather_grid.addWidget(self.rain_val, 3, 1)
        
        weather_grid.addWidget(QLabel("CPU"), 4, 0)
        self.cpu_val = QLabel("--%")
        weather_grid.addWidget(self.cpu_val, 4, 1)
        self.cpu_bar = QProgressBar()
        self.cpu_bar.setFixedHeight(4)
        self.cpu_bar.setTextVisible(False)
        self.cpu_bar.setProperty("class", "CpuBar")
        weather_grid.addWidget(self.cpu_bar, 5, 0, 1, 2)
        ...
        weather_grid.addWidget(self.ram_bar, 7, 0, 1, 2)

        weather_grid.addWidget(QLabel("Disk C:"), 8, 0)
        self.disk_val = QLabel("--%")
        weather_grid.addWidget(self.disk_val, 8, 1)
        self.disk_bar = QProgressBar()
        self.disk_bar.setFixedHeight(4)
        self.disk_bar.setTextVisible(False)
        self.disk_bar.setProperty("class", "DiskBar")
        weather_grid.addWidget(self.disk_bar, 9, 0, 1, 2)
        
        weather_grid.addWidget(QLabel("DL ⬇️"), 10, 0)
        self.net_down_val = QLabel("-- KB/s")
        weather_grid.addWidget(self.net_down_val, 10, 1)
        ...
        weather_grid.addWidget(self.net_down_bar, 11, 0, 1, 2)
        
        weather_grid.addWidget(QLabel("UP ⬆️"), 12, 0)
        self.net_up_val = QLabel("-- KB/s")
        weather_grid.addWidget(self.net_up_val, 12, 1)
        ...
        weather_grid.addWidget(self.net_up_bar, 13, 0, 1, 2)
    ...
    def update_weather(self):
        ...
        # 更新細項 (轉英文)
        city_en = "TAOYUAN" if self.current_city_name == "桃園" else self.current_city_name
        self.location_label.setText(city_en.upper())
